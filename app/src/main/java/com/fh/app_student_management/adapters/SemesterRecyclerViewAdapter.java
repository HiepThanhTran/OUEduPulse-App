...
import com.fh.app_student_management.ui.SubjectListActivity;
...
public class SemesterRecyclerViewAdapter extends RecyclerView.Adapter<SemesterRecyclerViewAdapter.SemesterViewHolder> implements Filterable {
    ...
    public SemesterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.z_layout_recycle_view_semester, parent, false);
